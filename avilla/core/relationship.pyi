...
class CoreSupport(MetaWrapper):
    @overload
    async def get(self, metakey: Literal["group.name"]) -> str: ...
    @overload
    async def set(self, metakey: Literal["group.name"], value: str) -> None: ...
    @overload
    async def get(self, metakey: Literal["group.description"]) -> str: ...
    @overload
    async def set(self, metakey: Literal["group.description"], value: str) -> None: ...
    async def reset(self, metakey: Literal["group.description"]) -> None: ...
    @overload
    async def get(self, metakey: Literal["group.max_count"]) -> int: ...
    @overload
    async def get(self, metakey: Literal["group.current_count"]) -> int: ...
    @overload
