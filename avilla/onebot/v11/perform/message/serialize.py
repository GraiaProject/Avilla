...
from avilla.core.elements import Face, Notice, NoticeAll, Picture, Text, Reference, Audio
...
from avilla.onebot.v11.resource import OneBot11ImageResource, OneBot11RecordResource
        ...
        if isinstance(element.resource, OneBot11RecordResource):
            ...
            return {
                ...
                "data": {
                    "file": "base64://"
                            + base64.b64encode(
                        cast(bytes, await self.account.staff.fetch_resource(element.resource))).decode(
                        "utf-8"
                    ),
                },
            }
