...
class ElizabethEventParser(AbstractEventParser["ElizabethProtocol"]):
    ...
    @event("GroupMessage")
    async def group_message(self, protocol: ElizabethProtocol, account: ElizabethAccount, raw: dict):
    ...
    @event("FriendMessage")
    async def friend_message(self, protocol: ElizabethProtocol, account: ElizabethAccount, raw: dict):
        message_chain = raw["messageChain"]
        source = None
        quote = None
        for i in message_chain:
    ...
    @event("TempMessage")
    async def temp_message(self, protocol: ElizabethProtocol, account: ElizabethAccount, raw: dict):
        message_chain = raw["messageChain"]
        source = None
        quote = None
        for i in message_chain:
