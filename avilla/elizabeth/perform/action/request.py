...
class ElizabethRequestActionPerform((m := AccountCollector["ElizabethProtocol", "ElizabethAccount"]())._):
    ...
    @RequestCapability.accept.collect(m, "land.group.request")
    ...
    @RequestCapability.reject.collect(m, "land.group.request")
    ...
    @RequestCapability.ignore.collect(m, "land.group.request")
    ...
    @RequestCapability.reject.collect(m, "land.group.contact.request")
    ...
    @RequestCapability.accept.collect(m, "land.group.member.request")
